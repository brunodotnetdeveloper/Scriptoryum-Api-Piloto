...
namespace Scriptoryum.Api.Migrations
{
    ...
    [Migration("20250820002552_TransformCompanyToOrganizationAndAddWorkspace")]
    partial class TransformCompanyToOrganizationAndAddWorkspace
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Scriptoryum.Api.Domain.Entities.AIConfiguration", b =>
                {
                    ...
                    b.HasOne("Scriptoryum.Api.Domain.Entities.Organization", null)
                        .WithMany("AIConfigurations")
